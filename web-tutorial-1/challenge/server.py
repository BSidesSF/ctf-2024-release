...
# csp one (vanilla xss) use cookie a9c34919feb87e179b6e42a88d87de011555bf1b
...
def xssOneResult():
    ...
    if request.method == 'GET' and 'admin' in request.cookies and request.cookies.get("admin") == u"a9c34919feb87e179b6e42a88d87de011555bf1b":
...
def xssOneFlag():
    if 'admin' in request.cookies and request.cookies.get("admin") == u"a9c34919feb87e179b6e42a88d87de011555bf1b":
        return "CTF{try-50me-XS5}"
    else:
